...
Definir un lenguaje comun para errores del sistema, aunque la respuesta HTTP actual todavia use principalmente el formato default de NestJS.
...
Hoy la API devuelve el formato default de NestJS para excepciones HTTP.
