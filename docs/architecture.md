...
6. El controller devuelve `201` con la company creada.
...
Ante el primer cambio breaking en contratos publicos, se recomienda migrar a `/api/v1` y congelar el contrato anterior durante una ventana de transicion.
